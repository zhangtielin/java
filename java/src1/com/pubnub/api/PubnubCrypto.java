...
class PubnubCrypto extends PubnubCryptoCore {
    ...
    public JSONObject encrypt31(JSONObject message) {
        try {
            ...
            while(it.hasNext()) {
                ...
                message_encrypted.put(key, encrypt31(val));
            }
     ...
     */
    @SuppressWarnings("unchecked")
    public JSONObject decrypt31(JSONObject message_encrypted) {
        try {
            ...
            while(it.hasNext()) {
                ...
                String decrypted_str = decrypt31(encrypted_str);
     ...
     */
    public JSONArray encryptJSONArray31(JSONArray jsona_arry) {
        try {
            ...
            for (int i = 0; i < jsona_arry.length(); i++) {
                 ...
                 if(o != null) {
                     if(o instanceof JSONObject) {
                         jsona_decrypted.put(i, encrypt31((JSONObject)o));
                     } else if(o instanceof JSONArray) {
                         jsona_decrypted.put(i, encryptJSONArray31((JSONArray)o));
                     } else if(o instanceof String) {
                         jsona_decrypted.put(i, encrypt31(o.toString()));
                     }
                 }
            }
     ...
     * @return JSONArray - Decrypted JSONArray
     */
    public JSONArray decryptJSONArray31(JSONArray jsona_encrypted) {
        try {
            JSONArray jsona_decrypted = new JSONArray();
            ...
            for (int i = 0; i < jsona_encrypted.length(); i++) {
                 ...
                 if(o != null) {
                     if(o instanceof JSONObject) {
                         jsona_decrypted.put(i, decrypt31((JSONObject)o));
                     } else if(o instanceof JSONArray) {
                         jsona_decrypted.put(i, decryptJSONArray31((JSONArray)o));
                     } else if(o instanceof String) {
                         jsona_decrypted.put(i, decrypt31(o.toString()));
                     }
                 }
            }
     ...
     * @throws Exception
     */
    public String encrypt31(String plain_text) throws Exception {
     ...
     * @throws Exception
     */
    public String decrypt31(String cipher_text) throws Exception {
